...
export const PortfolioItems = [
    {
        ...
        description: `This button is an animated button which created with only html and css. The border of this button are initially invisible and a line is drawn at a specific time period .When you hover on this button a large shadow of the button will be visible. Also you will find the mirror of this button below the object button. An awesome combination is made with these buttons whoose are visible like neon light. That's why they are named as neon button. Click on the live link to observe the buttons effect.`
    },
    {
        id: 2,
        category: 'wordpress',
